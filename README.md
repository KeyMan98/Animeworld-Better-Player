...
- **Freccette ( ↑ ↓ )** - Volume -/+
- **Spazio/Click mouse** -  Play/Pausa
- **Freccette ( ← → )** - Seek
- **(F)** - Entra/Esce dal Fullscreen
- **(M)** - Volume/Muto
...
- **Seek** → Salto temporale personalizzato da 5 a 30s con 
- **Velocità** → Velocità di riproduzione personalizzabile da 0.25x a 3x
- **AutoResume** → L'episodio riprende in automatico dall'ultimo punto in cui è stato interrotto
- **Autoplay** → L'episodio parte da solo quando metti in fullscreen
- **Episodio automatico** → Riapre la pagina della serie all’ultimo episodio visto
...
- Compatibile con MAL-Sync (trigger 90%)  
- Richiede [Tampermonkey](https://www.tampermonkey.net/) o [Violentmonkey](https://violentmonkey.github.io/)
- Assicurati che l'estensione abbia attiva la lettura dei siti e che siano consentiti gli script utente.
